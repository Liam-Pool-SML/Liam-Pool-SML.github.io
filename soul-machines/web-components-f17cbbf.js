...
function Pb({
	...
	return S("div", {
		className: `sm-fixed sm-bottom-0 sm-p-2 sm-text-primary-text sm-z-max sm-pointer-events-none sm-h-full md:sm-p-5 ${u}`,
		children: S("div", {
			className: "sm-flex sm-flex-col sm-gap-y-2 sm-h-full sm-justify-end md:sm-gap-y-5",
			children: [S("div", {
				...
				className: `sm-flex sm-flex-wrap sm-gap-2 sm-items-center sm-justify-end md:sm-gap-5 ${f}`,
				children: [!l && S("div", {
